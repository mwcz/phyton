...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('photos_photo', 'thumbnail', self.gf('django.db.models.fields.CharField')(default='0123456789', max_length=1024), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.thumbnail'
        db.delete_column('photos_photo', 'thumbnail')
